...
public class TaskQueryDto extends AbstractQueryDto<TaskQuery> {
  ...
  private static final String SORT_BY_NAME_CI_VALUE = "nameCaseInsensitive";
  ...
  static {
    ...
    VALID_SORT_BY_VALUES.add(SORT_BY_NAME_CI_VALUE);
  ...
  protected void applySortingOptions(TaskQuery query) {
    if (sortBy != null) {
      ...
      } else if (sortBy.equals(SORT_BY_NAME_CI_VALUE)) {
