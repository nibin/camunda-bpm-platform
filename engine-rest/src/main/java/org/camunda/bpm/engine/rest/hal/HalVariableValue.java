...
public class HalVariableValue extends HalResource<HalVariableValue> {
  ...
  public static HalVariableValue fromVariableInstance(VariableInstance variableInstance) {
    ...
    VariableValueDto valueDto = VariableValueDto.fromTypedValue(variableInstance.getTypedValue());
    dto.value = valueDto.getValue();
    dto.type = valueDto.getType();
    dto.valueInfo = valueDto.getValueInfo();
